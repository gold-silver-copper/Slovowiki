...
Tagging is a human release decision — CI never tags. Consumers pin
`data-vN`, verify artifacts against `data/MANIFEST.json` (plain sha256),
and read `data/refresh-changelog.md` to see exactly what moved since their
previous pin.
