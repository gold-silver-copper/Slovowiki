...
| Generated content | The generated dataset (`data/wiktionary-lab.json`), the entry pages the site renders, and the benchmark reports under `target/eval/` | **CC BY-SA 4.0 + GFDL** (inherited from Wiktionary), and **machine-generated / unverified** |
